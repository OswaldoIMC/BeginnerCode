...
const CsharpScreen = () => {
  ...
  const navigation =
    useNavigation<StackNavigationProp<RootStackParamList, "Csharp">>();
  ...
  const loadCourseData = async () => {
    try {
      ...
      const csharpCourse = DataService.getCourseById("csharp");
      setCourse(csharpCourse || null);

      // Obtener las lecciones del curso
      const csharpLessons = DataService.getLessonsByCourse("csharp");
      setLessons(csharpLessons);
      ...
      <ScrollView contentContainerStyle={styles.lessonList}>
        <View style={styles.contentContainer}>
          ...
          <View style={styles.headerContainer}>
            <Image source={CsharpImage} style={styles.logo} />
