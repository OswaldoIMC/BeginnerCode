...
const JsScreen = () => {
  ...
  const navigation =
    useNavigation<StackNavigationProp<RootStackParamList, "Javascript">>();
  ...
  const loadCourseData = async () => {
    try {
      ...
      const jsCourse = DataService.getCourseById("javascript");
      setCourse(jsCourse || null);

      // Obtener las lecciones del curso
      const jsLessons = DataService.getLessonsByCourse("javascript");
      ...
      <ScrollView contentContainerStyle={styles.lessonList}>
        <View style={styles.contentContainer}>
          ...
          <View style={styles.headerContainer}>
            <Image source={JsImage} style={styles.logo} />
